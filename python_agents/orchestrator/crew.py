    ...
    def run(self, query: dict) -> dict:
        ...
        return {
            ...
            "sentiment": {
                ...
                "queryIntent": sentiment.get("queryIntent", []),
                "directAnswer": sentiment.get("directAnswer"),
                "researchOnlyAction": sentiment.get("researchOnlyAction"),
                "policySignals": sentiment.get("policySignals"),
            },
            "prediction": prediction,
            "risk": risk,
