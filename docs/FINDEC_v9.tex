...
realised outcome, together with the deployed Analyst's directional accuracy
at three horizons.
...
Table~\ref{tab:abstain} and Figure~\ref{fig:coverage} report accuracy as a
...
$0.539$, $11.52\%$ and $-33.8\%$, dominating on all three. A fully invested
